    ...
    "paths": {
        ...
        "/posts": {
            "post": {
                ...
                "responses": {
                    "201": {
                        "description": "Contains the ID of the created post",
                        "schema": {
                            "$ref": "#/definitions/main.CreatePostResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/store.FeedPost"
                            }
                        }
                    },
                    "400": {
    ...
    "definitions": {
        "main.CreatePostPayload": {
            ...
            "properties": {
                ...
                "tags": {
                    "description": "optional field, default null",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
